...
def test_reftypes_jwst_reference_name_to_tpn_infos(default_shared_state, jwst_data):    # doctest: +ELLIPSIS
    ...
    expected = """('DETECTOR', 'HEADER', 'CHARACTER', 'OPTIONAL', values=())
     ...
     ('META.SUBARRAY.NAME', 'HEADER', 'CHARACTER', 'OPTIONAL', values=('BRIGHTSKY', 'MIRIFU_CH1', 'MIRIFU_CH2', 'MIRIFU_CH3', 'MIRIFU_CH4', 'MASK1065', 'MASK1140', 'MASK1550', 'MASKLYOT', 'SLITLESSPRISM', 'SLITLESSPRISM_IP', 'SLITLESSPRISM_IPS', 'SUB128', 'SUB128_IP', 'SUB256', 'SUB64', 'SUB64_IP', 'SUBSLIT', 'FULL', 'GENERIC', 'ANY', 'N/A'))
