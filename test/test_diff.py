...
def test_diff_print_all_new_files(capsys, default_shared_state, hst_data):
    ...
    assert output == f"""CRDS - INFO - 0 errors
...
def dt_diff_recurse_added_deleted_na():
    ...
    assert output == f"""(('.../mappings/hst/hst.pmap', '{hst_data}/hst.pmap'), ('hst_cos.imap',), '{hst_data}/hst_cos_twozxtab_0262.rmap', ('FUV', 'SPECTROSCOPIC', '3.0'), ('2009-05-11', '00:00:00'), 'added terminal z2d1925ql_2zx.fits')
