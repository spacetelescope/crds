...
def test_get_context_history(jwst_no_cache_state):
    ...
    assert history[0] == ('2012-09-06 00:00:00+00:00', 'jwst.pmap', 'Bootstrap mappings')
    assert history[32] == ('2015-11-18 12:58:13+00:00', 'jwst_0105.pmap', 'Declared various EXP_TYPE as N/A for 15 WCS types for MIRI, NIRCAM, NIRSPEC. Replacement MIRI distortion references for CRDS #238.')
...
def test_query_affected_datasets_list(jwst_no_cache_state, capsys):
    ...
    expected = """
    (0, '2012-09-06 00:00:00+00:00', 'jwst.pmap', 'Bootstrap mappings')
    (1, '2012-09-27 00:00:00+00:00', 'jwst_0000.pmap', 'First rules and references from jwst_gentools stub development cloning.')
    (2, '2013-04-13 00:00:00+00:00', 'jwst_0001.pmap', 'Linearity and dark files.')
    ...
    (10, '2014-07-24 18:49:03+00:00', 'jwst_0025.pmap', 'Replaced PHOTOM references for NIRSPEC and NIRISS.')
    """
