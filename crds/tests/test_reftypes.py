...
def reftypes_jwst_reference_name_to_tpn_infos():
    ...
    [('DETECTOR', 'HEADER', 'CHARACTER', 'OPTIONAL', values=()),
     ...
     ('FULLFRAME_XSIZE', 'HEADER', 'EXPRESSION', 'IF_FULL_FRAME', expression='(META_SUBARRAY_XSIZE==1032)'),
     ('FULLFRAME_XSTART', 'HEADER', 'EXPRESSION', 'IF_FULL_FRAME', expression='(META_SUBARRAY_XSTART==1)'),
     ('FULLFRAME_YSIZE', 'HEADER', 'EXPRESSION', 'IF_FULL_FRAME', expression='(META_SUBARRAY_YSIZE==1024)'),
     ('FULLFRAME_YSTART', 'HEADER', 'EXPRESSION', 'IF_FULL_FRAME', expression='(META_SUBARRAY_YSTART==1)'),
