...
def reftypes_jwst_reference_name_to_tpn_infos():    # doctest: +ELLIPSIS
    ...
    [('DETECTOR', 'HEADER', 'CHARACTER', 'OPTIONAL', values=()),
     ...
     ('META.INSTRUMENT.CORONAGRAPH', 'HEADER', 'CHARACTER', 'OPTIONAL', values=('4QPM', '4QPM_1065', '4QPM_1140', '4QPM_1550', 'LYOT', 'LYOT_2300', 'MASKA210R', 'MASKASWB', 'MASKA335R', 'MASKA430R', 'MASKALWB', 'MASK210R', 'MASKSWB', 'MASK335R', 'MASK430R', 'MASKLWB', 'NONE', 'ANY', 'N/A')),
