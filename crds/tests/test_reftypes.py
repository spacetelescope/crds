...
def reftypes_jwst_reference_name_to_tpn_infos():
    ...
    [('DETECTOR', 'HEADER', 'CHARACTER', 'OPTIONAL', values=()),
     ...
     ('META.INSTRUMENT.BAND', 'HEADER', 'CHARACTER', 'OPTIONAL', values=('SHORT', 'MEDIUM', 'LONG', 'SHORT-MEDIUM', 'MEDIUM-SHORT', 'SHORT-LONG', 'LONG-SHORT', 'MEDIUM-LONG', 'LONG-MEDIUM', 'ANY', 'N/A')),
