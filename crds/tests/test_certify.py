...
def certify_table_comparison_context():
    ...
    CRDS - INFO -  ########################################
    CRDS - INFO -  Certifying '.../y951738kl_hv.fits' (1/1) as 'FITS' relative to context 'hst_0294.pmap'
...
def certify_jwst_invalid_asdf():
    ...
    CRDS - ERROR -  instrument='UNKNOWN' type='UNKNOWN' data='data/invalid.asdf' ::  Validation error : Input object does not appear to be ASDF...
    CRDS - INFO -  ########################################
    CRDS - INFO -  1 errors
    CRDS - INFO -  0 warnings
    CRDS - INFO -  3 infos
