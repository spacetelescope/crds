...
class RedCatApiScript(ReferenceSubmissionScript):
    ...
    script.
    """
    def __init__(self, observatory, string, *args, **keys):
        ...
        self._string = string
        self._observatory = observatory  # Already set in parent class from shell variable
    ...
    def __setitem__(self, key, value):
        ...
        # Keep old fields in sync (DOESN'T WORK THE OTHER WAY!):
        if key == 'change_level':
            self.args.change_level = value
